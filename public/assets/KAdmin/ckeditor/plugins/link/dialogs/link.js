...
( function() {
	CKEDITOR.dialog.add( 'link', function( editor ) {
		...
		var temp = currentPathname.split("Control");
		var pathName = temp[0]+"Control/";

		const currentURLWithProtocol = currentProtocol + '//' + currentHostname + pathName;
							...
							[
								{
									...
									label : 'Borwser Server Files'  // See Note 1 
								},
								{
									type : 'button',
									id : 'browseInternal',
									label : 'Get Internal Link',    // See Note 2
									attributes: {
										download: 'download'
									},
									filebrowser :
									{
										action : 'Browse',
										url : currentURLWithProtocol+'getLinks'
									}
								 }
							]
						}
