...
Route::prefix('{locale}/admin')
    ...
    ->group(function () {
        ...
        Route::prefix('settings')->name('admin.settings.')->group(function () {
            ...
            Route::post('/footer/update', [AdminSettingsController::class, 'updateFooter'])->name('footer.update');
            Route::post('/footer/reset', [AdminSettingsController::class, 'resetFooter'])->name('footer.reset');
            Route::post('/header/update', [AdminSettingsController::class, 'updateHeader'])->name('header.update');
            Route::post('/header/reset', [AdminSettingsController::class, 'resetHeader'])->name('header.reset');
            Route::post('/subheader/update', [AdminSettingsController::class, 'updateSubheader'])->name('subheader.update');
            Route::post('/subheader/reset', [AdminSettingsController::class, 'resetSubheader'])->name('subheader.reset');
            Route::get('/counters', [AdminSettingsController::class, 'getCounterSettings'])->name('counters.get');
            Route::post('/counters/update', [AdminSettingsController::class, 'updateCounters'])->name('counters.update');
            Route::post('/counters/reset', [AdminSettingsController::class, 'resetCounters'])->name('counters.reset');
