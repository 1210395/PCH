        ...
        <div class="flex flex-col md:flex-row items-center gap-8">
            ...
            <div class="text-center md:text-left text-white flex-1">
                ...
                <div class="flex flex-wrap gap-3 justify-center md:justify-start">
                    @php $institutionWebsite = \App\Helpers\UrlHelper::safe($institution->website ?? null); @endphp
                    @if($institutionWebsite)
                    <a href="{{ $institutionWebsite }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-4 py-2 bg-white text-purple-600 font-semibold rounded-lg hover:bg-gray-100 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
