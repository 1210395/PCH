...
@php
    ...
    // For manufacturers and showrooms, show products count; for others, show projects count
    $isManufacturerOrShowroom = in_array($designer->sector, ['manufacturer', 'showroom']);
...
<a href="{{ route('designer.portfolio', ['locale' => app()->getLocale(), 'id' => $designer->id]) }}"
    ...
    {{-- Content --}}
    <div class="p-4 sm:p-6 pt-0 relative flex flex-col flex-grow">
        {{-- Avatar --}}
        ...
        <div class="flex items-center justify-center gap-6 mb-4 pb-4 border-b border-gray-200">
            <div class="text-center">
                <div class="text-lg text-gray-900">{{ $designer->followers_count ?? 0 }}</div>
