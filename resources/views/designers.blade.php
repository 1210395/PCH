                ...
                <form action="{{ route('designers', ['locale' => app()->getLocale()]) }}" method="GET" class="flex gap-2">
                    ...
                    <div class="relative flex-1">
                        <input type="text"
                               ...
                               class="pl-10 rtl:pr-10 rtl:pl-4 pr-4 py-2.5 w-full sm:w-64 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        <svg class="w-5 h-5 text-gray-400 absolute left-3 rtl:right-3 rtl:left-auto top-1/2 -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
