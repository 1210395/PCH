                ...
                <div class="flex gap-2">
                    <div class="flex-1 relative">
                        <input
                            ...
                            class="w-full ps-10 pe-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        >
                        <svg class="search-icon-fixed absolute start-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                                    @foreach($allTags as $tag)
                                        ...
                                        >
                                            <span>{{ $tag }}</span>
                                            @if($isActive)
                                                <svg class="w-4 h-4 ms-1" fill="currentColor" viewBox="0 0 24 24">
