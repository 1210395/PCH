...
<div class="min-h-screen bg-gray-50">
    ...
    >
        ...
        <div class="relative z-10 container mx-auto px-4 h-full flex items-center justify-center text-center">
            <div>
                <h1 class="text-2xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">{{ __('Marketplace') }}</h1>
                <p class="text-sm sm:text-lg text-white/90 max-w-2xl mx-auto">
                    {{ __('Discover services, collaborations, showcases and opportunities from the design community') }}
                </p>
            </div>
        </div>
    </section>
