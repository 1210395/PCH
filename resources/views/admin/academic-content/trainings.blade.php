...
<div x-data="trainingsManager()" class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <a href="{{ route('admin.academic-content.trainings.create', ['locale' => app()->getLocale()]) }}" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium">
