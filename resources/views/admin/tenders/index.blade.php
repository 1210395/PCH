        ...
        <form method="GET" class="flex flex-wrap gap-4">
            <div class="flex-1 min-w-[250px]">
                <div class="relative">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" :placeholder="__('Search by title, publisher, or description...')" class="w-full pl-10 rtl:pr-10 rtl:pl-4 pr-4 py-2 border rounded-lg">
                </div>
            </div>
