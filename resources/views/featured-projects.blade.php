...
<section id="featured-projects" class="py-10 sm:py-12 bg-gray-50">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6">
        <div class="flex items-center justify-between mb-6 sm:mb-8">
            <div>
                <h2 class="text-2xl sm:text-3xl md:text-4xl mb-2 text-gray-900">Featured Projects</h2>
                <p class="text-gray-600">Discover outstanding work from creative professionals</p>
            </div>
