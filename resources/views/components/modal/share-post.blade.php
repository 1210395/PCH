            ...
            <div x-show="activeTab === 'people'" class="p-5 space-y-4">
                ...
                <template x-if="!shared">
                    <div class="space-y-4">
                        ...
                        {{-- Search input --}}
                        <div class="relative">
                            <div class="absolute left-3 rtl:right-3 rtl:left-auto top-1/2 -translate-y-1/2">
                            ...
                            <input type="text"
                                   ...
                                   class="w-full pl-11 rtl:pr-11 rtl:pl-4 pr-4 py-3 text-sm bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:bg-white outline-none transition-all">
