<!-- Add Project Modal - REDESIGNED -->
<div x-show="addProjectModal"
     x-cloak
     class="fixed inset-0 z-50 overflow-y-auto"
     style="display: none;">
    <div class="fixed inset-0 bg-black bg-opacity-50 transition-opacity"
         @click="addProjectModal = false"></div>
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="relative bg-white rounded-xl shadow-xl border border-gray-200 max-w-2xl w-full p-4 sm:p-6 max-h-[90vh] overflow-y-auto">
            <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">{{ __('Add New Project') }}</h3>
            ...
            <div class="flex gap-3 mt-6">
                <button @click="addProjectModal = false"
                ...
                <button @click="submitAddProject()"
                    ...
                    <span x-show="!isSubmitting">{{ __('Create Project') }}</span>
