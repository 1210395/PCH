    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 py-4">
        <div class="flex items-center justify-between gap-4">
            <div class="flex items-center gap-4 min-w-0">
                <a href="{{ $backUrl }}" class="flex-shrink-0 p-2 hover:bg-gray-100 rounded-lg transition-all duration-200 hover:scale-110">
            ...
            <div class="flex gap-2 sm:gap-3 flex-shrink-0">
                <a href="{{ $backUrl }}" class="inline-flex items-center px-3 sm:px-4 py-2 border border-gray-300 hover:border-gray-400 bg-white text-gray-700 rounded-lg font-medium transition-all duration-200 hover:shadow-md text-sm">
