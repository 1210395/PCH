...
<section class="py-10 sm:py-16 bg-white">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6">
        <div class="flex items-center justify-between mb-6 sm:mb-8">
            <div>
                <h2 class="text-2xl sm:text-3xl md:text-4xl mb-1 sm:mb-2 text-gray-900">{{ __('Top Designers') }}</h2>
                <p class="text-gray-600">{{ __('Connect with talented creatives and artists') }}</p>
            </div>
            <a href="{{ route('designers', ['locale' => app()->getLocale(), 'type' => 'designers']) }}" class="hidden md:inline-flex items-center px-4 py-2 border-2 border-gray-300 text-gray-700 font-medium rounded-lg hover:border-gray-400 hover:bg-gray-50 transition-all duration-200">
                {{ __('View All') }}
        ...
        @if($designers && $designers->count() > 0)
            <div class="mt-8 text-center md:hidden">
                <a href="{{ route('designers', ['locale' => app()->getLocale(), 'type' => 'designers']) }}" class="inline-flex items-center px-6 py-3 border-2 border-gray-300 text-gray-700 font-medium rounded-lg hover:border-gray-400 hover:bg-gray-50 transition-all duration-200">
