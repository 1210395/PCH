            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl overflow-hidden shadow-sm">
                    ...
                    <div class="p-6">
                        ...
                        @auth('designer')
                        @if(auth('designer')->id() === $post->designer_id)
                            <div class="flex gap-2 mb-4" id="postOwnerActions">
                                <button type="button" onclick="deleteMarketplacePost({{ $post->id }})" class="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-red-700 bg-red-50 border border-red-200 rounded-lg hover:bg-red-100">
