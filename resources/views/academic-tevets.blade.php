            ...
            <div class="flex-1">
                <div class="relative">
                    <input
                        ...
                        class="w-full px-4 py-2.5 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    >
                ...
                >
                    ...
                    @foreach($cities as $city)
                        <option value="{{ $city }}" {{ request('city') == $city ? 'selected' : '' }}>
                            {{ \App\Models\DropdownOption::localize($city, 'city') }}
                        </option>
                    @endforeach
                </select>
            </div>
                        ...
                        <a href="{{ route('academic-institution.show', ['locale' => app()->getLocale(), 'id' => $institution->id]) }}" class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all group block">
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex items-center gap-2 text-sm text-gray-500 mb-2">
                                    ...
                                    <span>{{ \App\Models\DropdownOption::localize($institution->city, 'city') }}</span>
                                </div>
                                @endif
                        ...
                        <a href="{{ route('designer.portfolio', ['locale' => app()->getLocale(), 'id' => $privateSector->id]) }}" class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all group block">
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex items-center gap-2 text-sm text-gray-500 mb-2">
                                    ...
                                    <span>{{ \App\Models\DropdownOption::localize($privateSector->city, 'city') }}</span>
                                </div>
                                @endif
