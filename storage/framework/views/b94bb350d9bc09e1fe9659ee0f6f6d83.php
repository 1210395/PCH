...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['contentType']));
...
foreach (array_filter((['contentType']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div
    x-data="categorySubscription({
        contentType: '<?php echo e($contentType); ?>',
        isAuthenticated: <?php echo e($isAuthenticated ? 'true' : 'false'); ?>,
        getUrl: '<?php echo e(route('subscriptions.category.get', ['locale' => app()->getLocale(), 'contentType' => $contentType])); ?>',
        saveUrl: '<?php echo e(route('subscriptions.category.save', ['locale' => app()->getLocale(), 'contentType' => $contentType])); ?>',
        deleteUrl: '<?php echo e(route('subscriptions.category.delete', ['locale' => app()->getLocale(), 'contentType' => $contentType])); ?>',
        loginUrl: '<?php echo e(route('login', ['locale' => app()->getLocale(), 'redirect' => url()->current()])); ?>'
    })"
    x-init="init()"
    class="inline-block"
>
    ...
    >
        ...
        <span x-text="hasSubscription ? '<?php echo e(__('Notification Settings')); ?>' : '<?php echo e(__('Subscribe to Notifications')); ?>'"></span>
    </button>
    <?php else: ?>
    
    <a
        href="<?php echo e(route('login', ['locale' => app()->getLocale(), 'redirect' => url()->current()])); ?>"
    ...
    >
        ...
        <span><?php echo e(__('Subscribe to Notifications')); ?></span>
    </a>
    <?php endif; ?>
            ...
            >
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 mb-4">
                        <span x-show="contentType === 'marketplace'"><?php echo e(__('Select which tags you want to receive notifications for. Leave empty to receive all notifications.')); ?></span>
                        <span x-show="contentType !== 'marketplace'"><?php echo e(__('Select which categories you want to receive notifications for. Leave empty to receive all notifications.')); ?></span>
                    </p>
                    ...
                    <div x-show="loadingOptions" class="py-8 text-center">
                        ...
                        <p class="text-gray-500 mt-2"><?php echo e(__('Loading options...')); ?></p>
                    </div>
                    ...
                    <div x-show="!loadingOptions" class="space-y-4">
                        ...
                        <div x-show="availableOptions.levels && availableOptions.levels.length > 0">
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                <?php echo e(__('Difficulty Levels')); ?>
                ...
                <div class="mt-6 flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
                    ...
                    >
                        <span x-show="!saving"><?php echo e(__('Save Preferences')); ?></span>
...
<?php if (! $__env->hasRenderedOnce('b44ae0cc-bc31-4559-b31f-e3c781df2a66')): $__env->markAsRenderedOnce('b44ae0cc-bc31-4559-b31f-e3c781df2a66'); ?>
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\Users\Jadallah\Downloads\PalestineCreativeHub (4)\PalestineCreativeHub\resources\views/components/category-subscribe-button.blade.php ENDPATH**/ ?>