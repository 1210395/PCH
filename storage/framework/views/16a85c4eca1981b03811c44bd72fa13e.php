    ...
    <div class="absolute inset-0 flex items-center justify-center p-4"
        ...
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-lg max-h-[85vh] overflow-y-auto">
            ...
            <div x-show="step === 1" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0" class="px-6 pb-6">
                <h2 class="text-xl font-bold text-gray-900 mb-1"><?php echo e(__('What are you looking for?')); ?></h2>
                <p class="text-sm text-gray-500 mb-5"><?php echo e(__('We\'ll help you find exactly what you need')); ?></p>
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <button @click="selectIntent('talent')"
                        ...
                        <span class="text-sm font-semibold text-gray-700 group-hover:text-blue-700"><?php echo e(__('Find Talent')); ?></span>
                    </button>
                    ...
                    <button @click="selectIntent('work')"
                        ...
                        <span class="text-sm font-semibold text-gray-700 group-hover:text-emerald-700"><?php echo e(__('Browse Work')); ?></span>
                    </button>
                    ...
                    <button @click="selectIntent('services')"
                        ...
                        <span class="text-sm font-semibold text-gray-700 group-hover:text-violet-700"><?php echo e(__('Find Services')); ?></span>
                    </button>
                    ...
                    <button @click="selectIntent('learn')"
                        ...
                        <span class="text-sm font-semibold text-gray-700 group-hover:text-amber-700"><?php echo __('Learn & Train'); ?></span>
                    </button>
                    ...
                    <button @click="selectIntent('suppliers')"
                        ...
                        <span class="text-sm font-semibold text-gray-700 group-hover:text-orange-700"><?php echo e(__('Suppliers')); ?></span>
                    </button>
                    ...
                    <button @click="selectIntent('fablabs')"
                        ...
                        <span class="text-sm font-semibold text-gray-700 group-hover:text-teal-700"><?php echo e(__('FabLabs')); ?></span>
                    </button>
                </div>

                <button @click="dismiss()" class="w-full mt-5 py-2.5 text-sm text-gray-400 hover:text-gray-600 transition-colors font-medium">
                    <?php echo e(__('Just browsing')); ?>
            ...
            <div x-show="step === 3" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0" class="px-6 pb-6">
                ...
                <h2 class="text-xl font-bold text-gray-900 mb-1"><?php echo e(__('Where are you located?')); ?></h2>
                <p class="text-sm text-gray-500 mb-4"><?php echo e(__('Find what\'s near you, or explore everything')); ?></p>
                ...
                <div class="space-y-2 max-h-[45vh] overflow-y-auto pr-1">
                    ...
                    <button @click="goToPage(null)"
                        ...
                        <span class="text-sm font-bold text-blue-700"><?php echo e(__('All Cities')); ?></span>
                    </button>
...
function discoverWizard() {
    const baseUrl = <?php echo json_encode($baseUrl, 15, 512) ?>;
    return {
        show: false,
        step: 1,
        totalSteps: 3,
        ...
        sectors: <?php echo json_encode($sectors, 15, 512) ?>,
        productCategories: <?php echo json_encode($productCategories, 15, 512) ?>,
        projectCategories: <?php echo json_encode($projectCategories, 15, 512) ?>,
        serviceCategories: <?php echo json_encode($serviceCategories, 15, 512) ?>,
        ...
        buildStep2(intent) {
            switch (intent) {
                case 'talent':
                    this.step2Title = '<?php echo e(__("What type of talent?")); ?>';
                    this.step2Subtitle = '<?php echo e(__("Choose a specialization")); ?>';
                ...
                case 'work':
                    this.step2Title = '<?php echo e(__("What type of work?")); ?>';
                    this.step2Subtitle = '<?php echo e(__("Browse creative output")); ?>';
                    this.step2Options = [
                        { value: 'products_all', label: '<?php echo e(__("All Products")); ?>', redirectPath: '/products' },
                        ...this.productCategories.map(c => ({
                            value: 'p_' + c,
                            label: c + ' (<?php echo e(__("Products")); ?>)',
                            redirectPath: '/products?category=' + encodeURIComponent(c)
                        })),
                        { value: 'projects_all', label: '<?php echo e(__("All Projects")); ?>', redirectPath: '/projects' },
                        ...this.projectCategories.map(c => ({
                            value: 'pr_' + c,
                            label: c + ' (<?php echo e(__("Projects")); ?>)',
                ...
                case 'services':
                    this.step2Title = '<?php echo e(__("What service do you need?")); ?>';
                    this.step2Subtitle = '<?php echo e(__("Find the right service provider")); ?>';
                    this.step2Options = [
                        { value: 'all', label: '<?php echo e(__("All Services")); ?>', redirectPath: '/services' },
                ...
                case 'learn':
                    this.step2Title = '<?php echo e(__("How would you like to learn?")); ?>';
                    this.step2Subtitle = '<?php echo e(__("Explore training and opportunities")); ?>';
                    this.step2Options = [
                        { value: 'trainings', label: '<?php echo __("Trainings & Workshops"); ?>', redirectPath: '/trainings' },
                        { value: 'tenders', label: '<?php echo __("Tenders & Opportunities"); ?>', redirectPath: '/tenders' },
                        { value: 'academic', label: '<?php echo e(__("Academic Institutions")); ?>', redirectPath: '/academic-tevets' }
                    ];
                    break;

                case 'suppliers':
                    this.step2Title = '<?php echo e(__("What type of supplier?")); ?>';
                    this.step2Subtitle = '<?php echo e(__("Find manufacturers and suppliers")); ?>';
                    this.step2Options = [
                        { value: 'all', label: '<?php echo __("All Suppliers & Manufacturers"); ?>', redirectPath: '/designers?type=manufacturers' },
                        { value: 'manufacturer', label: '<?php echo e(__("Manufacturers")); ?>', redirectPath: '/designers?type=manufacturers&sector=manufacturer' },
                        { value: 'showroom', label: '<?php echo e(__("Showrooms")); ?>', redirectPath: '/designers?type=manufacturers&sector=showroom' },
                        { value: 'vendor', label: '<?php echo e(__("Vendors / Suppliers")); ?>', redirectPath: '/designers?type=manufacturers&sector=vendor' }
                    ];
                    break;
            }
        },
...
<?php endif; ?>
<?php /**PATH C:\Users\Jadallah\Downloads\PalestineCreativeHub (4)\PalestineCreativeHub\resources\views/components/home/discover-wizard.blade.php ENDPATH**/ ?>