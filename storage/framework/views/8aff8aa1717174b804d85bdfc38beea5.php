...
<a href="<?php echo e(route('product.detail', ['locale' => app()->getLocale(), 'id' => $product->id])); ?>" class="group bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 cursor-pointer flex flex-col h-full">
    ...
    <div class="p-3 sm:p-4 flex flex-col flex-grow">
        ...
        <h3 class="text-sm sm:text-base font-semibold text-gray-900 mb-1 sm:mb-2 line-clamp-1"><?php echo e($product->name); ?></h3>

        
        <p class="text-xs sm:text-sm text-gray-600 line-clamp-2 mb-3 min-h-[2.5rem]"><?php echo e($product->description ?? ''); ?></p>
...
<?php /**PATH C:\Users\Jadallah\Downloads\PalestineCreativeHub (4)\PalestineCreativeHub\resources\views/components/home/product-card.blade.php ENDPATH**/ ?>