    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 py-4">
        <div class="flex items-center justify-between gap-4 sm:gap-8">
            ...
            <div class="flex items-center gap-4 sm:gap-8 lg:gap-12">
                <!-- Logo -->
                <a href="<?php echo e(url('/')); ?>" class="cursor-pointer">
                    <img src="<?php echo e(asset('images/logo.webp')); ?>" alt="Palestine Creative Hub" class="h-[3.6rem]">
                </a>

                <!-- Main Navigation - Desktop -->
                <nav class="hidden lg:flex items-center gap-8">
                    <?php $__currentLoopData = $headerSettings['nav_links'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navLink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $navTitle = (app()->getLocale() === 'ar' && !empty($navLink['title_ar'])) ? $navLink['title_ar'] : $navLink['title'];
                        ?>
                        <?php if(($navLink['type'] ?? 'link') === 'dropdown'): ?>
                            ...
                            <div class="relative" x-data="{ open: false }" @click.away="open = false">
                                ...
                                <div x-show="open"
                                     ...
                                     style="display: none;">
                                    <?php $__currentLoopData = $navLink['children'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childLink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(url(app()->getLocale() . $childLink['url'])); ?>"
                                           class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600 transition-colors">
                                            <?php echo e((app()->getLocale() === 'ar' && !empty($childLink['title_ar'])) ? $childLink['title_ar'] : $childLink['title']); ?>

                                        </a>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                        <?php elseif(!empty($navLink['highlight'])): ?>
                            <a href="<?php echo e(url(app()->getLocale() . $navLink['url'])); ?>" class="px-4 py-2 rounded-full bg-blue-600 text-white hover:bg-blue-700 transition-all shadow-md hover:shadow-lg">
                                <?php echo e($navTitle); ?>

                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(url(app()->getLocale() . $navLink['url'])); ?>" class="text-gray-700 hover:text-gray-900 transition-colors">
                                <?php echo e($navTitle); ?>
            ...
            <div class="hidden md:flex flex-1 max-w-md" x-data="searchDropdown()" @click.away="showResults = false">
                <div class="relative w-full">
                    <form action="<?php echo e(route('search', ['locale' => app()->getLocale()])); ?>" method="GET" class="relative w-full">
                        ...
                        <input
                            ...
                            placeholder="<?php echo e(__('Search designers, projects, products...')); ?>"
                    ...
                    <div x-show="showResults && hasResults"
                        ...
                        <template x-if="results.designers && results.designers.length > 0">
                            <div class="border-b border-gray-100">
                                <div class="px-4 py-2 bg-gray-50 text-xs font-semibold text-gray-500 uppercase tracking-wider"><?php echo e(__('Designers')); ?></div>
                                <template x-for="designer in results.designers" :key="'d-'+designer.id">
                                    <a :href="'<?php echo e(url(app()->getLocale())); ?>/designer/' + designer.id"
                                       class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors">
                                        <template x-if="designer.avatar">
                                            <img :src="'<?php echo e(url('media')); ?>/' + designer.avatar" class="w-10 h-10 rounded-full object-cover">
                                        </template>
                                        <template x-if="!designer.avatar">
                        ...
                        <template x-if="results.projects && results.projects.length > 0">
                            <div class="border-b border-gray-100">
                                <div class="px-4 py-2 bg-gray-50 text-xs font-semibold text-gray-500 uppercase tracking-wider"><?php echo e(__('Projects')); ?></div>
                                <template x-for="project in results.projects" :key="'p-'+project.id">
                                    <a :href="'<?php echo e(url(app()->getLocale())); ?>/projects/' + project.id"
                                       class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors">
                                        <template x-if="project.image">
                                            <img :src="'<?php echo e(url('media')); ?>/' + project.image" class="w-12 h-10 rounded-lg object-cover">
                                        </template>
                                        <template x-if="!project.image">
                        ...
                        <template x-if="results.products && results.products.length > 0">
                            <div>
                                <div class="px-4 py-2 bg-gray-50 text-xs font-semibold text-gray-500 uppercase tracking-wider"><?php echo e(__('Products')); ?></div>
                                <template x-for="product in results.products" :key="'pr-'+product.id">
                                    <a :href="'<?php echo e(url(app()->getLocale())); ?>/products/' + product.id"
                                       class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors">
                                        <template x-if="product.image">
                                            <img :src="'<?php echo e(url('media')); ?>/' + product.image" class="w-12 h-10 rounded-lg object-cover">
                                        </template>
                                        <template x-if="!product.image">
                                            <div class="w-12 h-10 rounded-lg bg-gray-200 flex items-center justify-center">
                                                <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a :href="'<?php echo e(route('search', ['locale' => app()->getLocale()])); ?>?q=' + encodeURIComponent(query)"
                           class="block px-4 py-3 text-center text-sm font-semibold text-blue-600 hover:bg-blue-50 transition-colors border-t border-gray-200">
                            <?php echo e(__('View all results for')); ?> "<span x-text="query"></span>"
                    ...
                    <div x-show="showResults && !hasResults && !loading && query.length >= 2"
                        ...
                        <p class="text-gray-500"><?php echo e(__('No results found for')); ?> "<span x-text="query" class="font-medium"></span>"</p>
                        <p class="text-gray-400 text-sm mt-1"><?php echo e(__('Try different keywords or')); ?> <a :href="'<?php echo e(route('search', ['locale' => app()->getLocale()])); ?>?q=' + encodeURIComponent(query)" class="text-blue-500 hover:underline"><?php echo e(__('view full search')); ?></a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="<?php echo e($switchUrl); ?>"
                   ...
                   title="<?php echo e($currentLocale === 'ar' ? 'Switch to English' : 'التبديل إلى العربية'); ?>">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0112 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 013 12c0-1.605.42-3.113 1.157-4.418"/>
                    </svg>
                    <span><?php echo e($currentLocale === 'ar' ? 'EN' : 'عربي'); ?></span>
                </a>

                <?php if(auth()->guard('designer')->check()): ?>
                ...
                <div class="hidden md:block relative" x-data="messagesDropdown()" @click.away="closeDropdown()">
                    <button @click="toggleDropdown()" class="relative p-2 hover:bg-gray-100 rounded-full transition-colors group">
                        ...
                        <span id="unreadBadge" class="absolute -top-1 -right-1 w-5 h-5 bg-gradient-to-r from-blue-600 to-green-500 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-lg <?php echo e($totalUnread > 0 ? '' : 'hidden'); ?>">
                            <span id="unreadCount"><?php echo e($totalUnread > 9 ? '9+' : $totalUnread); ?></span>
                        </span>
                        <!-- Message requests badge -->
                        <span id="requestsBadge" class="absolute -top-1 -left-1 w-5 h-5 bg-gradient-to-r from-purple-600 to-pink-500 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-lg animate-pulse <?php echo e($pendingRequestsCount > 0 ? '' : 'hidden'); ?>">
                            <span id="requestsCount"><?php echo e($pendingRequestsCount > 9 ? '9+' : $pendingRequestsCount); ?></span>
                        </span>
                    </button>
                    ...
                    <div x-show="open"
                        ...
                        <div class="px-4 py-3 bg-gradient-to-r from-blue-600 to-green-500 text-white">
                            <div class="flex items-center justify-between">
                                <h3 class="font-semibold"><?php echo e(__('Messages')); ?></h3>
                                <span class="text-xs bg-white/20 px-2 py-0.5 rounded-full"><?php echo e($totalUnread); ?> <?php echo e(__('unread')); ?></span>
                            </div>
                            <!-- Message Requests Link -->
                            <a id="requestsLink" href="<?php echo e(route('messages.requests', ['locale' => app()->getLocale()])); ?>"
                               class="mt-2 flex items-center justify-between text-xs bg-white/20 hover:bg-white/30 px-3 py-1.5 rounded-lg transition-colors <?php echo e($pendingRequestsCount > 0 ? '' : 'hidden'); ?>">
                                <span class="flex items-center gap-1">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"/>
                                    </svg>
                                    <span id="requestsLinkCount"><?php echo e($pendingRequestsCount); ?></span> <?php echo e(__('Message Requests')); ?>
                        ...
                        <div class="max-h-[320px] overflow-y-auto">
                            ...
                            <button @click="openChat(<?php echo e($chat['id']); ?>, <?php echo \Illuminate\Support\Js::from($chat['other_user']->name)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($chat['other_user']->avatar ? url('media/' . $chat['other_user']->avatar) : null)->toHtml() ?>, <?php echo e($chat['other_user']->id); ?>)"
                                    class="w-full flex items-center gap-3 px-4 py-3 hover:bg-gray-50 transition-colors border-b border-gray-100 last:border-b-0 text-left <?php echo e($chat['unread_count'] > 0 ? 'bg-blue-50/50' : ''); ?>">
                                <!-- Avatar -->
                                <div class="relative flex-shrink-0">
                                    <?php if($chat['other_user']->avatar): ?>
                                    <img src="<?php echo e(url('media/' . $chat['other_user']->avatar)); ?>" alt="<?php echo e($chat['other_user']->name); ?>" class="w-12 h-12 rounded-full object-cover">
                                    <?php else: ?>
                                    <div class="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-green-400 flex items-center justify-center text-white font-semibold">
                                        <?php echo e(strtoupper(substr($chat['other_user']->name, 0, 1))); ?>
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center justify-between mb-0.5">
                                        <span class="font-semibold text-gray-900 truncate <?php echo e($chat['unread_count'] > 0 ? 'text-blue-600' : ''); ?>"><?php echo e($chat['other_user']->name); ?></span>
                                        <span class="text-[10px] text-gray-400 flex-shrink-0 ml-2"><?php echo e($chat['updated_at'] ? $chat['updated_at']->diffForHumans(null, true, true) : ''); ?></span>
                                    </div>
                                    <p class="text-sm text-gray-500 truncate <?php echo e($chat['unread_count'] > 0 ? 'font-medium text-gray-700' : ''); ?>">
                                        <?php if($chat['last_message']): ?>
                                            <?php echo e(Str::limit($chat['last_message']->message, 35)); ?>

                                        <?php else: ?>
                                            <?php echo e(__('Start a conversation')); ?>
                            ...
                            <div class="px-4 py-8 text-center">
                                ...
                                <p class="text-gray-500 text-sm"><?php echo e(__('No messages yet')); ?></p>
                            </div>
                            <?php endif; ?>
                        </div>

                        <!-- View All Link -->
                        <a href="<?php echo e(route('messages.index', ['locale' => app()->getLocale()])); ?>"
                           class="block px-4 py-3 text-center text-sm font-semibold text-blue-600 hover:bg-blue-50 transition-colors border-t border-gray-200">
                            <?php echo e(__('View All Messages')); ?>
                ...
                <div class="hidden md:block relative" x-data="notificationsDropdown()" @click.away="closeDropdown()">
                    ...
                    <div x-show="open"
                        ...
                        <div class="px-4 py-3 bg-gradient-to-r from-blue-600 to-green-500 text-white">
                            <div class="flex items-center justify-between">
                                <h3 class="font-semibold"><?php echo e(__('Notifications')); ?></h3>
                        ...
                        <div class="max-h-[320px] overflow-y-auto">
                            ...
                            <template x-if="!loading && notifications.length === 0">
                                <div class="px-4 py-8 text-center">
                                    ...
                                    <p class="text-gray-500 text-sm"><?php echo e(__('No notifications yet')); ?></p>
                                </div>
                            </template>
                ...
                <?php if(auth()->guard('designer')->guest()): ?>
                <a href="<?php echo e(route('login', ['locale' => app()->getLocale(), 'redirect' => url()->current()])); ?>" class="hidden md:block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-md transition-colors">
                    <?php echo e(__('Log In')); ?>

                </a>

                <a href="<?php echo e(route('register', ['locale' => app()->getLocale()])); ?>" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-md transition-colors shadow-sm">
                ...
                <div class="flex items-center gap-3">
                    <div class="relative" x-data="{ open: false }" @click.away="open = false">
                        ...
                        <button @click="open = !open" class="flex items-center gap-2 hover:opacity-80 transition-opacity">
                            <?php if(Auth::guard('designer')->user()->avatar): ?>
                            <img src="<?php echo e(url('media/' . Auth::guard('designer')->user()->avatar)); ?>" alt="<?php echo e(Auth::guard('designer')->user()->name); ?>" class="w-8 h-8 rounded-full object-cover border-2 border-transparent hover:border-blue-500 transition-all">
                            <?php else: ?>
                            <div class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-green-400 flex items-center justify-center text-white text-sm font-medium border-2 border-transparent hover:border-blue-600 transition-all">
                                <?php echo e(strtoupper(substr(Auth::guard('designer')->user()->name, 0, 1))); ?>
                        ...
                        <div x-show="open"
                            ...
                            <div class="px-4 py-3 border-b border-gray-100">
                                <p class="text-sm font-semibold text-gray-900"><?php echo e(Auth::guard('designer')->user()->name); ?></p>
                                <p class="text-xs text-gray-500 truncate"><?php echo e(Auth::guard('designer')->user()->email); ?></p>
                            </div>
                            ...
                            <div class="py-2">
                                ...
                                <a href="<?php echo e(route('profile', ['locale' => app()->getLocale()])); ?>"
                                ...
                                <a href="<?php echo e(route('profile.edit', ['locale' => app()->getLocale()])); ?>"
                                   class="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('messages.index', ['locale' => app()->getLocale()])); ?>"
                                   class="flex items-center justify-between px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                                    ...
                                    <span id="unreadBadgeDropdown" class="px-2 py-0.5 text-xs font-bold bg-gradient-to-r from-blue-600 to-green-500 text-white rounded-full <?php echo e($totalUnread > 0 ? '' : 'hidden'); ?>">
                                        <span id="unreadCountDropdown"><?php echo e($totalUnread > 9 ? '9+' : $totalUnread); ?></span>
                                    </span>
                                </a>

                                <!-- Account Settings - For all users -->
                                <a href="<?php echo e(route('account.settings', ['locale' => app()->getLocale()])); ?>"
                                   class="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div id="mobileMenu" class="hidden lg:hidden border-t border-gray-100 bg-white">
    <div class="px-4 py-4 space-y-3">
        <!-- Mobile Search Bar -->
        <div class="md:hidden">
            <form action="<?php echo e(route('search', ['locale' => app()->getLocale()])); ?>" method="GET" class="relative">
                ...
                <input
                    ...
                    placeholder="<?php echo e(__('Search creative work...')); ?>"
                    value="<?php echo e(request('q') ?? ''); ?>"
                >
            </form>
        </div>
        ...
        <?php $__currentLoopData = $headerSettings['nav_links'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navLink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if(($navLink['type'] ?? 'link') === 'dropdown'): ?>
                ...
                <div x-data="{ open: false }" class="border-b border-gray-100 last:border-b-0">
                    <button @click="open = !open" class="w-full flex items-center justify-between px-4 py-2 text-base font-medium text-gray-700 hover:bg-gray-50 rounded-md">
                        <span><?php echo e($mobileNavTitle); ?></span>
                    ...
                    <div x-show="open" x-collapse class="bg-gray-50">
                        <?php $__currentLoopData = $navLink['children'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childLink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(url(app()->getLocale() . $childLink['url'])); ?>" class="block px-8 py-2 text-sm text-gray-600 hover:bg-gray-100 hover:text-blue-600">
                                <?php echo e((app()->getLocale() === 'ar' && !empty($childLink['title_ar'])) ? $childLink['title_ar'] : $childLink['title']); ?>
            ...
            <?php elseif(!empty($navLink['highlight'])): ?>
                <a href="<?php echo e(url(app()->getLocale() . $navLink['url'])); ?>" class="block px-4 py-2 text-base font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-full text-center">
                    <?php echo e($mobileNavTitle); ?>

                </a>
            <?php else: ?>
                <a href="<?php echo e(url(app()->getLocale() . $navLink['url'])); ?>" class="block px-4 py-2 text-base font-medium text-gray-700 hover:bg-gray-50 rounded-md">
                    <?php echo e($mobileNavTitle); ?>
        ...
        <div class="border-t border-gray-100 pt-3">
            <a href="<?php echo e($switchUrl); ?>"
               ...
               class="flex items-center gap-3 px-4 py-2 text-base font-medium text-gray-700 hover:bg-gray-50 rounded-md">
                ...
                <span><?php echo e($currentLocale === 'ar' ? 'English' : 'العربية'); ?></span>
            </a>
        </div>
        ...
        <div class="pt-4 border-t border-gray-100 space-y-2">
            <a href="<?php echo e(route('login', ['locale' => app()->getLocale(), 'redirect' => url()->current()])); ?>" class="block w-full px-4 py-2 text-center text-base font-medium text-gray-700 hover:bg-gray-50 rounded-md border border-gray-200">
                <?php echo e(__('Log In')); ?>

            </a>
            <a href="<?php echo e(route('register', ['locale' => app()->getLocale()])); ?>" class="block w-full px-4 py-2 text-center text-base font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-md">
                <?php echo e(__('Sign Up')); ?>
        ...
        <div class="pt-4 border-t border-gray-100">
            ...
            <div class="px-4 py-3 bg-gray-50 rounded-lg mb-3">
                <div class="flex items-center gap-3">
                    <?php if(Auth::guard('designer')->user()->avatar): ?>
                    <img src="<?php echo e(url('media/' . Auth::guard('designer')->user()->avatar)); ?>" alt="<?php echo e(Auth::guard('designer')->user()->name); ?>" class="w-10 h-10 rounded-full object-cover">
                    <?php else: ?>
                    ...
                    <?php endif; ?>
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-semibold text-gray-900 truncate"><?php echo e(Auth::guard('designer')->user()->name); ?></p>
                        <p class="text-xs text-gray-500 truncate"><?php echo e(Auth::guard('designer')->user()->email); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-1">
                ...
                <a href="<?php echo e(route('profile', ['locale' => app()->getLocale()])); ?>"
                   class="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 rounded-md transition-colors">
                    ...
                    <span><?php echo e(__('View Profile')); ?></span>
                </a>
                ...
                <a href="<?php echo e(route('messages.index', ['locale' => app()->getLocale()])); ?>"
                   class="flex items-center justify-between px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 rounded-md transition-colors">
                    ...
                    <span id="unreadBadgeMobile" class="px-2 py-1 text-xs font-bold bg-gradient-to-r from-blue-600 to-green-500 text-white rounded-full <?php echo e($mobileTotalUnread > 0 ? '' : 'hidden'); ?>">
                        <span id="unreadCountMobile"><?php echo e($mobileTotalUnread > 9 ? '9+' : $mobileTotalUnread); ?></span>
                    </span>
                </a>

                <!-- Message Requests Link (Mobile) -->
                <a href="<?php echo e(route('messages.requests', ['locale' => app()->getLocale()])); ?>"
                   id="requestsLinkMobile"
                   class="flex items-center justify-between px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 rounded-md transition-colors <?php echo e($mobilePendingRequests > 0 ? '' : 'hidden'); ?>">
                    <div class="flex items-center gap-3">
                        <svg class="w-5 h-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"/>
                        </svg>
                        <span><?php echo e(__('Message Requests')); ?></span>
                    </div>
                    <span id="requestsBadgeMobile" class="px-2 py-1 text-xs font-bold bg-gradient-to-r from-purple-600 to-pink-500 text-white rounded-full animate-pulse <?php echo e($mobilePendingRequests > 0 ? '' : 'hidden'); ?>">
                        <span id="requestsCountMobile"><?php echo e($mobilePendingRequests > 9 ? '9+' : $mobilePendingRequests); ?></span>
                    </span>
                </a>
                ...
                <!-- Logout - For all users -->
                <form method="POST" action="<?php echo e(route('logout', ['locale' => app()->getLocale()])); ?>" class="mt-2">
                    <?php echo csrf_field(); ?>
        ...
        <div class="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-blue-600 to-green-500 text-white rounded-t-xl cursor-pointer" onclick="toggleChatMinimize()">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <span id="chatStatus" class="text-[10px] opacity-80"><?php echo e(__('Online')); ?></span>
                </div>
            </div>
            ...
            <div id="chatMessages" class="flex-1 overflow-y-auto p-4 space-y-3 bg-gray-50">
                ...
                <div id="chatLoading" class="flex items-center justify-center h-full">
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <span class="text-sm text-gray-500"><?php echo e(__('Loading messages...')); ?></span>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function searchDropdown() {
        return {
            ...
            async search() {
                ...
                try {
                    const response = await fetch('<?php echo e(route("search.instant", ["locale" => app()->getLocale()])); ?>?q=' + encodeURIComponent(this.query), {
                        headers: {
    ...
    function notificationsDropdown() {
        return {
            ...
            async fetchUnreadCount() {
                try {
                    const response = await fetch('<?php echo e(route("notifications.unreadCount", ["locale" => app()->getLocale()])); ?>', {
                        headers: {
                            'Accept': 'application/json',
                            'X-Requested-With': 'XMLHttpRequest'
                        }
            ...
            async fetchNotifications() {
                this.loading = true;
                try {
                    const response = await fetch('<?php echo e(route("notifications.index", ["locale" => app()->getLocale()])); ?>', {
                        headers: {
                            'Accept': 'application/json',
                            'X-Requested-With': 'XMLHttpRequest'
                        }
            ...
            async markAsRead(notification) {
                ...
                if (!notification.read) {
                    try {
                        await fetch('<?php echo e(url(app()->getLocale())); ?>/notifications/' + notification.id + '/mark-read', {
                            method: 'POST',
                            headers: {
                                'Accept': 'application/json',
                                'X-Requested-With': 'XMLHttpRequest',
                ...
                const baseUrl = '<?php echo e(url(app()->getLocale())); ?>';
            ...
            async markAllAsRead() {
                try {
                    await fetch('<?php echo e(route("notifications.markAllAsRead", ["locale" => app()->getLocale()])); ?>', {
                        method: 'POST',
                        headers: {
                            'Accept': 'application/json',
                            'X-Requested-With': 'XMLHttpRequest',
    ...
    window.expandChat = function() {
        if (window.chatState.otherUserId) {
            window.location.href = '<?php echo e(url(app()->getLocale())); ?>/messages/chat/' + window.chatState.otherUserId;
        }
    };
    ...
    async function loadChatMessages(conversationId) {
        ...
        try {
            const response = await fetch('<?php echo e(url(app()->getLocale())); ?>/messages/' + conversationId + '/fetch', {
                headers: {
                    'Accept': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                }
    ...
    function renderMessages() {
        const container = document.getElementById('chatMessages');
        const currentUserId = <?php echo e(Auth::guard('designer')->id()); ?>;
    ...
    async function sendMessage(event) {
        ...
        try {
            const response = await fetch('<?php echo e(url(app()->getLocale())); ?>/messages/' + window.chatState.conversationId + '/send', {
                method: 'POST',
                headers: {
    ...
    async function markMessagesAsRead(conversationId) {
        try {
            await fetch('<?php echo e(url(app()->getLocale())); ?>/messages/' + conversationId + '/mark-read', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                    'Accept': 'application/json'
    ...
    function startMessagePolling(conversationId) {
        ...
        window.chatState.pollInterval = setInterval(async () => {
            ...
            try {
                const response = await fetch('<?php echo e(url(app()->getLocale())); ?>/messages/' + conversationId + '/fetch?since=' + (window.chatState.messages.length > 0 ? window.chatState.messages[window.chatState.messages.length - 1].id : 0), {
                    headers: {
                        'Accept': 'application/json',
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                    }
    ...
    function updateUnreadCount() {
        fetch('<?php echo e(route("messages.unreadCount", ["locale" => app()->getLocale()])); ?>', {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
    ...
    function updatePendingRequestsCount() {
        fetch('<?php echo e(route("messages.pendingRequestsCount", ["locale" => app()->getLocale()])); ?>', {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php /**PATH C:\Users\Jadallah\Downloads\PalestineCreativeHub (4)\PalestineCreativeHub\resources\views/partials/_navbar.blade.php ENDPATH**/ ?>